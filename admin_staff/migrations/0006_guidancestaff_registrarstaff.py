...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admin_staff', '0005_facultystaff_sufix_studentprofile_sufix_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            name='guidanceStaff',
            fields=[
                ('guidance_staff_id', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='registrarStaff',
            fields=[
                ('registrar_staff_id', models.BigIntegerField(primary_key=True, serialize=False)),
                ('surname', models.CharField(max_length=24)),
                ('first_name', models.CharField(max_length=24)),
                ('middle_name', models.CharField(blank=True, max_length=24, null=True)),
                ('sufix', models.CharField(blank=True, max_length=24, null=True)),
