...
urlpatterns = [
    ...
    path('payment-details/<int:payment_id>', views.details, name='details'),
    ...
    path('admission_student_profile/<int:student_lrn>', views.admission_student_profile, name='admission_student_profile'),
